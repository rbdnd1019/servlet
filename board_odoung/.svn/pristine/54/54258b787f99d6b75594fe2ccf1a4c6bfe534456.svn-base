                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form>
						  ...
						  <div class="mb-3">
						    <label for="content" class="form-label"><i class="fas fa-comment"></i> content</label>
						  ...
						  <div class="mb-3">
						    <label for="regDate" class="form-label"><i class="fas fa-clock"></i> regDate</label>
						  ...
						  <button type="button" class="btn btn-primary btn-sm float-end" id="btnReplyReg">reply regiser</button>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <div class="mb-3 mt-3">
				    ...
				    <input type="text" class="form-control" id="rno" name="rno" " disabled>
				  </div>
				  <div class="mb-3">
				    <label for="replyContent" class="form-label"><i class="fas fa-comment"></i> content</label>
				    <textarea class="form-control" id="replyContent" name="replyContent" ></textarea>
				  </div>
				  <div class="mb-3">
				    <label for="replyRegDate" class="form-label"><i class="fas fa-clock"></i> regDate</label>
				...
				function showList(){
					replyService.list(bno, function(data) {
						...
						for(var i in data){
							...
							str +='                            <span class="small">' + data[i].regDate + '</span>';
							str +='                        </div>';
